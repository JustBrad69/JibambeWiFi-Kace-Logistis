    ...
    <section id="payment" className="py-16 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-blue-900 mb-2">Payment Information</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Pay for your Jibambe Wifi packages easily using M-Pesa. Simply send the payment to our till number.
          </p>
        </div>
        
        <div className="max-w-4xl mx-auto bg-yellow-50 rounded-xl overflow-hidden shadow-lg">
          <div className="bg-yellow-500 p-4 text-center">
            <h3 className="text-xl font-bold text-blue-900">M-Pesa Payment Details</h3>
          </div>
            ...
            <div className="flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0">
              <div className="text-center md:text-left">
                ...
                <div className="flex items-center justify-center md:justify-start">
                  ...
                  <span className="text-2xl font-bold text-blue-900">5624982</span>
                </div>
              </div>
              ...
              <div className="text-center md:text-left">
                ...
                <p className="text-xl font-semibold text-blue-900">Kace Logistics Limited</p>
              </div>
            </div>
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          <div className="bg-white rounded-lg shadow-md p-6 border border-gray-200">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-xl font-semibold text-blue-900">Call or WhatsApp</h3>
            </div>
            <p className="text-gray-700 mb-4">For support or inquiries, contact us via phone or WhatsApp:</p>
            <a href="tel:0707374749" className="text-xl font-bold text-blue-600 hover:underline">0707374749</a>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 border border-gray-200">
            ...
            <a href="mailto:info@kacelogisticsltd.com" className="text-lg font-bold text-blue-600 hover:underline break-all">info@kacelogisticsltd.com</a>
          </div>
        </div>
      </div>
    </section>
