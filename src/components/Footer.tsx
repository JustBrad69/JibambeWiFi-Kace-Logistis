  ...
  return (
    <footer className="bg-blue-900 text-white pt-12 pb-6">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            <div className="flex items-center mb-4">
              <Wifi className="h-6 w-6 text-blue-200 mr-2" />
              <span className="text-xl font-bold">Jibambe <span className="text-blue-200">Wifi</span></span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#packages" className="text-blue-200 hover:text-white transition-colors">Packages</a></li>
              <li><a href="#coverage" className="text-blue-200 hover:text-white transition-colors">Coverage Areas</a></li>
              <li><a href="#payment" className="text-blue-200 hover:text-white transition-colors">Payment Information</a></li>
              <li><a href="#contact" className="text-blue-200 hover:text-white transition-colors">Help & Support</a></li>
            </ul>
          </div>
          ...
          <div id="contact">
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start">
                <CreditCard className="h-5 w-5 text-blue-200 mr-2 mt-0.5" />
        ...
        <div className="pt-6 mt-6 border-t border-blue-800 text-center">
