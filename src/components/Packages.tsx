    ...
    <section id="packages" className="py-16 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-[#000080] mb-2">Affordable Internet Packages</h2>
          ...
          <div className="flex flex-wrap justify-center gap-6 mt-8">
            <div className="flex items-center">
              <Clock className="w-5 h-5 text-[#000080] mr-2" />
              <span className="text-gray-700">Flexible durations</span>
            </div>
            <div className="flex items-center">
              <Users className="w-5 h-5 text-[#000080] mr-2" />
              <span className="text-gray-700">Multiple device options</span>
            </div>
            <div className="flex items-center">
              <Download className="w-5 h-5 text-[#000080] mr-2" />
